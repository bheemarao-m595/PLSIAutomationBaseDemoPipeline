...
public class RequestAppointmentPageJohn {
    ...
    public RequestAppointmentPageJohn(WebDriver d){
...
//        client.click();
        ...
        Thread.sleep(3000);
        Building.sendKeys(BaseClass.datasheet.get("Building"));
        Building.sendKeys(Keys.TAB);
        Thread.sleep(3000);
        Department.sendKeys(BaseClass.datasheet.get("Department"));
        Department.sendKeys(Keys.TAB);
        Thread.sleep(3000);
        PatientMRN.sendKeys(BaseClass.datasheet.get("Patient MRN"));
        PatientMRN.sendKeys(Keys.TAB);
        Thread.sleep(3000);
        FirstName.sendKeys(BaseClass.datasheet.get("First Name"));
        FirstName.sendKeys(Keys.TAB);
        Thread.sleep(3000);
        LastName.sendKeys(BaseClass.datasheet.get("LastName"));
        LastName.sendKeys(Keys.TAB);
        Thread.sleep(3000);
        DOB.sendKeys(BaseClass.datasheet.get("DOB"));
        DOB.sendKeys(Keys.TAB);
        Thread.sleep(3000);
        PatientGender.sendKeys(BaseClass.datasheet.get("Select Patient Gender"));
        PatientGender.sendKeys(Keys.TAB);
        Thread.sleep(3000);
        RequestedLanguage.sendKeys(BaseClass.datasheet.get("Requested Language"));
        RequestedLanguage.sendKeys(Keys.TAB);
        Thread.sleep(3000);
        AlternateLanguage.sendKeys(BaseClass.datasheet.get("Alternate Language"));
        AlternateLanguage.sendKeys(Keys.TAB);
        Thread.sleep(3000);
        Prefrences.sendKeys(BaseClass.datasheet.get(" Preferences"));
        ...
        searchbar.sendKeys(BaseClass.datasheet.get(" "));
