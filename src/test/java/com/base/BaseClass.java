...
public class BaseClass
{
	...
	public WebDriver openBrowser() throws IOException {
		...
		if(prop.get("driver").equals("firefox")) {
			...
			opt.addArguments("enable-automation"); opt.addArguments("--headless"); opt.addArguments("--window-size=1920,1080"); opt.addArguments("--no-sandbox"); opt.addArguments("--disable-extensions"); opt.addArguments("--dns-prefetch-disable"); opt.addArguments("--disable-gpu");
